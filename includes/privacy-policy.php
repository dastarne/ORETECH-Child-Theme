...
$site_Domain = $uncg_unit_settings['siteDomain'];
$site_Dept = $uncg_unit_settings['siteDepartment'];
$siteAdminEmail = $uncg_unit_settings['siteAdminEmail'];

echo 
'<div class="uk-margin-medium" property="text">

<h3>APPLICABLE TO ONLY THE ' . $site_Domain . ' DOMAIN.</h3>


<p>'.$site_Dept.' (“us”, “we”, or “our”) operates the ' .$site_Domain. ' domain &nbsp;(the “Service”).</p>
...
<p>Service is the http://' .$site_Domain. '/ website operated by ' .$site_Dept. '.</p>
...
<ul><li>Email address</li><li>First name and
     last name</li><li>Phone number</li><li>Address, State,
     Province, ZIP/Postal code, City</li><li>Cookies and
     Usage Data</li></ul>
...
<ul>
    ...
    <li><strong>Security Cookies.</strong>&nbsp;We use
     Security Cookies for security purposes.</li>
</ul>
...
<p>' .$site_Dept. ' uses the collected data for various purposes:</p>



<ul>
<li>To provide and
     maintain our Service</li>
...
<p>If you are from the European Economic Area (EEA), ' .$site_Dept. ' legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>



<p>' .$site_Dept. ' may process your Personal Data because:</p>
...
<ul>
    ...
    <li>To comply with the law</li></ul>
...
<p>' .$site_Dept. ' will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>



<p>' .$site_Dept. ' will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer time periods.</p>
...
<p>' .$site_Dept. ' will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
...
<p>Under certain circumstances, ' .$site_Dept. ' may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
...
<p>' .$site_Dept. ' may disclose your Personal Data in the good faith belief that such action is necessary to:</p>



<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of ' .$site_Dept. ' </li>
...
<p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. ' .$site_Dept. ' aims to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>



<p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please&nbsp;<a href="mailto:' .$siteAdminEmail. '">contact us</a>.</p>
...
<p><strong>The right to withdraw consent.</strong>&nbsp;You also have the right to withdraw your consent at any time where ' .$site_Dept. ' relied on your consent to process your personal information.</p>
...
<p>We do not knowingly collect personally identifiable information from anyone under the ageof 18. If you are a parent or guardian and you are aware that your child has provided us with Personal Data, please&nbsp;<a href="mailto:' .$siteAdminEmail.' ">contact us</a>. If we become aware that we have collected Personal Data from children without verification of parental consent, we take steps to remove that information from our servers.</p>
